...
const SEED_PRODUCTS = [
    {
        ...
        status: "active",
        reviews: [
            { userName: "Karthik Raja", rating: 5, comment: "The bird pictures are very realistic. My child learned the Tamil names in a day!", date: new Date("2025-08-15") },
            { userName: "Priyadharshini", rating: 4, comment: "Excellent quality paper. The phonetic guide is very helpful for parents who aren't fluent.", date: new Date("2025-09-22") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Muthu Kumaran", rating: 5, comment: "Level 2 is even better! The sections on vehicles and cultural symbols are very informative.", date: new Date("2025-10-10") },
            { userName: "Kavitha Selvam", rating: 5, comment: "Our family loves the national symbols section. Great way to teach heritage to kids.", date: new Date("2025-11-05") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Rajesh Kannan", rating: 4, comment: "Simple and effective. The association between letters and pictures is perfect for 3-year-olds.", date: new Date("2025-08-28") },
            { userName: "Meena Kumari", rating: 5, comment: "This is the best Arichuvadi I've found. Very clean design and not cluttered.", date: new Date("2025-12-12") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Vijay Sethupathi", rating: 5, comment: "Level 2 builds perfectly on the first book. My daughter loves the rhymes at the end.", date: new Date("2025-09-09") },
            { userName: "Lakshmi Narayanan", rating: 5, comment: "High quality printing and very engaging. Worth every rupee for early learners.", date: new Date("2026-01-03") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Sangeetha Mani", rating: 5, comment: "The poems are so rhythmic! I catch my son humming them all day. Truly joyful.", date: new Date("2025-10-22") },
            { userName: "Dinesh Babu", rating: 5, comment: "Beautiful Tamil poetry for kids. It really sparks their imagination and love for the language.", date: new Date("2025-12-30") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Arulmozhi Varman", rating: 4, comment: "Waiting for this to restock! My first child loved the Level 1 book so much.", date: new Date("2025-11-15") },
            { userName: "Yazhini Devi", rating: 5, comment: "The illustrations in Pattam series are world-class. Hope it comes back to the hive soon!", date: new Date("2026-01-10") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Kavin Thangavel", rating: 5, comment: "A delightful English version. The transition from Tamil to English poems is very smooth.", date: new Date("2025-08-19") },
            { userName: "Mathi Maran", rating: 5, comment: "My kids enjoy the English rhymes just as much as the Tamil ones. Very well written!", date: new Date("2025-10-05") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Iniyan Selvan", rating: 4, comment: "Great collection of English poems for toddlers. Simple language and cute themes.", date: new Date("2025-11-30") },
            { userName: "Thamizhalagan", rating: 5, comment: "Every child should have this. It makes learning English poetry so much fun!", date: new Date("2025-12-18") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Malar Vizhi", rating: 5, comment: "The stories are so heartwarming. They really teach good values without being preachy.", date: new Date("2025-09-28") },
            { userName: "Shenbagam", rating: 5, comment: "Perfect bedtime stories. My daughter asks for one every single night!", date: new Date("2026-01-12") }
        ]
    },
    {
        ...
        status: "active",
        reviews: [
            { userName: "Ilango Adigal", rating: 5, comment: "Gentle and calming stories. The Twilight theme is perfect for winding down the day.", date: new Date("2025-12-05") },
            { userName: "Kannagi Selvi", rating: 5, comment: "The three tales are just the right length for a quick yet satisfying bedtime read.", date: new Date("2026-01-15") }
        ]
    }
];
...
const seedProducts = async () => {
    try {
        ...
        if (existingCount > 0) {
            logger.info(`Database already has ${existingCount} products. Updating stock for existing products.`);
