...
export const chatWithHive = async (req, res, next) => {
    try {
        ...
        try {
            ...
            if (q.includes("best") || q.includes("popular") || q.includes("top")) {
            ...
            else if (q.includes("cheap") || q.includes("price") || q.includes("cost") || q.includes("afford")) {
                ...
                responseText = "I'm buzzing with pride about our Tamil collection! We have everything from Balapaadam to rhythmic poem books. Which Level are you looking for? 📖";
            }
            else if (q.includes("delivery") || q.includes("ship") || q.includes("track")) {
                responseText = "Our bees deliver all across Tamil Nadu! Orders usually fly to your doorstep in 3-5 business days. 🚚💨";
            }
            else if (q.includes("who are you") || q.includes("robot") || q.includes("ai")) {
                responseText = "I'm Bernie the Bee! I help keep the SINGGLEBEE hive organized and help customers find the sweetest books. I'm part bee, part librarian, and all helpful! 🐝✨";
            }
            else {
                // Keyword match
                ...
                if (match) {
                    ...
                    responseText = "I'm buzzing around, but I couldn't find that specific item. Would you like to see our Bestsellers or check out our Tamil Books section? 🌻";
                }
            }
