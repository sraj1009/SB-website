    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat, index) => (
          <div key={index} className="bg-white rounded-[2rem] p-6 shadow-honey border-4 border-brand-primary/20 hover:scale-105 transition-transform">
      ...
      <div className="bg-white rounded-[2rem] p-6 shadow-honey border-4 border-brand-primary/20">
        ...
        <div className="space-y-4">
          {stats?.recentOrders?.slice(0, 5).map((order: any, index: number) => (
            <div key={index} className="flex items-center justify-between p-4 bg-brand-light rounded-xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-brand-black">{order.customerName || 'Unknown Customer'}</p>
