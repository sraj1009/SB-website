    ...
    <footer className="bg-brand-black text-white pt-6 md:pt-10 pb-6 rounded-t-[2rem] md:rounded-t-[4rem] mt-4 md:mt-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-16 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          <div className="space-y-6 text-center sm:text-left flex flex-col items-center sm:items-start">
            <div className="flex items-center gap-3">
              <span className="text-2xl font-extrabold tracking-tight drop-shadow-[0_0_15px_rgba(220,102,1,0.6)]">
                SINGGLE<span className="text-[#dc6601]">BEE</span>
              </span>
            </div>
            <p className="text-gray-400 font-medium text-sm leading-relaxed max-w-xs mx-auto sm:mx-0">
              Curating the best books and premium supplies for your family. Trusted by parents,
              loved by kids.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:contents gap-8">
            {footerGroups.map((group, i) => (
              <div key={i} className="text-center sm:text-left">
                <h4 className="font-extrabold text-brand-primary text-[10px] sm:text-xs mb-4 uppercase tracking-[0.2em]">
                  {group.title}
                </h4>
          ...
          <div className="text-center sm:text-left">
            ...
            {joined ? (
              ...
              <div className="max-w-[320px] sm:max-w-none mx-auto sm:mx-0">
                <p className="text-gray-400 font-medium text-xs mb-4">
                  Weekly honey drops and family deals directly to your hive.
                </p>
        ...
        <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-center gap-6 pb-4 sm:pb-0">
          <p className="text-gray-500 font-bold text-[9px] sm:text-[10px] uppercase tracking-[0.2em]">
            © 2026 SINGGLEBEE.
          </p>
        </div>
      </div>
