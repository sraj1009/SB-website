...
const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[300] p-4 animate-slide-up" style={{ fontFamily: '"Plus Jakarta Sans", "Quicksand", system-ui, sans-serif' }}>
      <div className="max-w-4xl mx-auto bg-brand-black border border-white/10 rounded-2xl shadow-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 backdrop-blur-xl">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-400 text-xs leading-relaxed">
            We use cookies to enhance your shopping experience, analyze site traffic, and provide personalized content.
            By clicking "Accept All", you consent to our use of cookies.
            <a href="#" className="text-amber-400 hover:text-amber-300 ml-1 underline underline-offset-2">Learn more</a>
          </p>
        </div>
        <div className="flex gap-2 shrink-0">
          <button onClick={handleEssentialOnly}
