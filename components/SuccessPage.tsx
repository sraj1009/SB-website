    ...
    const verifyPayment = async () => {
      ...
      try {
        ...
        const isPaid =
          ...
          (data?.type === 'order' && data?.paymentStatus === 'success') ||
        ...
        if (isPaid) {
          ...
          setTimeout(async () => {
            try {
              ...
              const retryPaid =
                retryData?.paymentStatus === 'success' ||
                retryData?.status === 'completed' ||
                retryData?.orderCreated === true;
              if (retryPaid) {
                setStatus('success');
      ...
      <div className="bg-white rounded-[4rem] p-12 md:p-20 max-w-2xl w-full text-center shadow-2xl border-[6px] border-brand-accent relative overflow-hidden animate-slide-up">
        ...
        {status === 'loading' && (
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-brand-black mb-6 tracking-tighter">
              Verifying Payment...
            </h2>
        ...
        {status === 'success' && (
          <div className="flex flex-col items-center animate-fade-in">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-brand-black mb-6 tracking-tighter">
              Bzz-tastic!
            </h2>
            ...
            <div className="bg-brand-light p-8 rounded-[2.5rem] border-4 border-white mb-10 shadow-inner">
              <p className="text-brand-black font-black text-lg italic opacity-80">
                Our hive team is already preparing your package! We'll buzz you as soon as it's
                shipped.
              </p>
            </div>
            <button
        ...
        {status === 'failed' && (
          <div className="flex flex-col items-center animate-fade-in">
            ...
            <h2 className="text-5xl md:text-6xl font-black text-brand-black mb-6 tracking-tighter">
              Payment Failed
            </h2>
